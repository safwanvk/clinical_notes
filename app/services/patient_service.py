...
async def create_patient(input: PatientInput, session: AsyncSession) -> PatientType:
      try:
...
async def update_patient_details(patient_id: int, input: PatientUpdateInput, session: AsyncSession) -> PatientType:
      try:
